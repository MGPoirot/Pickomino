...
#
#
# def remaining_rolls(collection: np.ndarray) -> np.ndarray:
#     """
...
#         return tile_probs
#
#     # Give all possible outcomes of rolling the remaining dice
#     outcomes = collection + remaining_rolls(collection)
#
...
# collection_state = np.array((0, 0, 0, 0, 0, 0))
# dice_roll = roll_dice(collection_state)
# dice_roll = np.array((1, 1, 1, 0, 1, 4))
